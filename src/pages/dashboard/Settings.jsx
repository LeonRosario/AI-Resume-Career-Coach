          ...
          {tabs.map((t) => (
            <button
              ...
              className={`relative flex items-center gap-2.5 px-4 py-3 rounded-2xl text-sm font-medium whitespace-nowrap transition-colors ${
                tab === t.id ? "text-primary-700" : "text-body hover:text-ink hover:bg-white/40"
              }`}
            >
              {tab === t.id && (
                <motion.span
      ...
      <div className="space-y-5">
        {tab === "profile" && (
          <GlassCard className="p-7">
            ...
            <p className="text-sm text-body mb-6">Update your name and contact details.</p>
        ...
        {tab === "history" && (
          <GlassCard className="p-7">
            ...
            <p className="text-sm text-body mb-6">Every version you've uploaded or built.</p>
        ...
        {tab === "preferences" && (
          <GlassCard className="p-7">
            ...
            <p className="text-sm text-body mb-6">Control how CareerAI looks and notifies you.</p>

            <div className="space-y-1">
              <div className="flex items-center justify-between py-4 border-b border-[rgba(0,132,255,0.12)]">
