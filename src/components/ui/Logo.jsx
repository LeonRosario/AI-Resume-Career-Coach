...
export default function Logo({ size = "md", to = "/", textColor }) {
  ...
  return (
    <Link to={to} className="inline-flex items-center gap-2.5 group">
      ...
      >
        <Sparkles size={iconSize} className="text-white" strokeWidth={2} />
      </span>
      <span className={`font-heading font-extrabold ${textSize} tracking-tight`} style={{ color: textColor || "#0F172A" }}>
