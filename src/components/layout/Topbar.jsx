  ...
  return (
    <div className="glass rounded-glass px-4 md:px-6 py-4 flex items-center justify-between mb-6 sticky top-4 z-30">
      <div className="flex items-center gap-3">
        <button
          className="md:hidden p-2 -ml-2 text-body hover:text-ink rounded-xl hover:bg-white/40"
          onClick={onMenuClick}
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <button
          className="relative p-2.5 rounded-xl glass-soft hover:bg-white/60 text-body hover:text-ink transition-colors"
